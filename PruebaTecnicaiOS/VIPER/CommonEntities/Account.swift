...
struct Account: Decodable {
    ...
    init(accountBalanceInCents: Int, accountCurrency: String, accountId: Int, accountName: String, accountNumber: MetadataType, accountType: String, alias: String, isVisible: Bool, iban: String, linkedAccountId: Int?, productName: String?, productType: Int?, savingsTargetReached: Int?, targetAmountInCents: Int?) {
    ...
    private enum CodingKeys: String, CodingKey {
        case accountBalanceInCents = "accountBalanceInCents"
